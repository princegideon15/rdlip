<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class=" nav-item">
        <a class="nav-link font-weight-bold text-primary border-bottom-primary" href="<?php echo base_url('rdlip/admin/dashboard_ilc');?>">Paper Presentation <span class="sr-only">(current)</span>
        <?php if($ilc_count > 0){?>
...
<div class="row pt-5">
    <div class="col mt-5 text-white font-weight-bold mb-1"><h1>Paper Presentation</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover text-dark" id="ilc_table" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Membership</th>
                                    ...
                                    <tbody>
                                    <?php foreach($ilc_apps as $row){
                                        $status = ($row->rd_status == 0) ? 'NEW' : 'APPROVED'; 
                                        $color = ($row->rd_status == 0) ? 'text-warning' : 'text-success'; 
                                       ...
                                       echo '<tr> 
                                            ...
                                            <button type="button" onclick="get_ilc(' . $row->rd_user_id . ')" class="btn btn-outline-secondary" data-toggle="modal" data-target="#info_modal">View Application</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content text-dark">
        ...
        <div id="docx">
            <div class="WordSection1">
                <table class="table table-bordered" id="info_table">
                    ...
                    <tr class="text-center"><th  colspan="2">Paper Presentation</th></tr>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="export_ilc()">Export</button>
      </div>
    </div>
  </div>
</div>
